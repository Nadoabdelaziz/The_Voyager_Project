...
<head>
	...
	<meta name="description" content="شركة شحن في تركيا | ادويت لوجيستيك"/>
	<meta property="og:title" content="شركة شحن في تركيا | ادويت لوجيستيك" />
	<meta property="og:description" content="شركة شحن في تركيا | ادويت لوجيستيك" />
	...
	<!-- PAGE TITLE HERE -->
	<title>شركة شحن في تركيا | ادويت لوجيستيك </title>
				...
				<div class="row d-flex justify-content-between align-items-center">
					<div class="dlab-topbar-left">
						<ul>
							...
							<li><a href="privacy">سياسة الاسترجاع</a></li>
							<li><a href="help-desk.html">مكتب المساعدة</a></li>
						</ul>
					</div>
					<div class="dlab-topbar-right">
						<a href="contactus" class="site-button radius-no btnhover13">إقتبس</a>						
					</div>
				</div>
			</div>
		</div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        ...
                        <ul class="nav navbar-nav">	
							<li class="active"> <a href="index.html">الصفحة الرئيسية</a>
							</li>
							<li><a href="shop_ship"> تجميع الشحنات</a></li>
							<li><a href="buy-for-me.html">اشتري لي</a></li>
						</ul>		
    ...
    <div class="page-content bg-white">
					...
					<ul>	
						...
						<li data-index="rs-3204" data-transition="slideoververtical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/main-slider/slide8.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="2000" data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="What our team has found in the wild" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							...
							<div class="tp-caption" 
								...
								data-paddingbottom="[0,0,0,0]"
								data-paddingleft="[0,0,0,0]"
								style="z-index: 7; white-space: normal; color:#fff; font-family: 'almarai', roboto; border-width:0px; font-weight:600;">
								{{setting('site.title')}} {{storage_path()}}
									</div>
							<!-- LAYER NR. 4 -->
							<div class="tp-caption tp-resizeme rs-parallaxlevel-1" 
								id="slide-100-layer-5" 
								data-x="['left','left','middle','middle']" data-hoffset="['-330','-400','0','0']" 
							...
							<div class="tp-caption" 
								...
								data-paddingbottom="[0,0,0,0]"
								data-paddingleft="[0,0,0,0]"
								style="z-index: 7; white-space: normal; color:#fff; font-family:'almarai', roboto; border-width:0px; text-transform:uppercase; font-weight:600;">
							...
							<div class="tp-caption  " 
								...
								data-paddingbottom="[0,0,0,0]"
								data-paddingleft="[0,0,0,0]"
								style="z-index: 7; white-space: normal; color:#fff; font-family:'almarai', roboto; border-width:0px; font-weight:400;">
								الجيل الجديد من خدمات الشحن عبر الانترنت
							</div>
							<!-- LAYER NR. 5 -->
							<a class="tp-caption rev-btn tp-resizeme" 
								...
								style="z-index: 13; white-space: normal; font-size: 17px; line-height: 50px; font-weight: 600; color: rgba(255, 255, 255, 1.00); display: inline-block;font-family:'almarai', roboto;background-color:rgba(255, 255, 255, 0);border-color:rgba(255, 255, 255, 1.00);border-style:solid;border-width:1px 1px 1px 1px;border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">اقرأ أكثر
							</a>
							<a class="tp-caption rev-btn tp-resizeme" 
								href="about-1.html" target="_blank"			 
								id="slide-411-layer-12" 
								data-x="['center','center','center','center']" 
								data-hoffset="['340','230','-80','-60']" 
								data-y="['center','center','middle','middle']" 
								data-voffset="['150','180','-20','40']" 
								data-width="none"
								data-height="none"
								...
								data-paddingbottom="[0,0,0,0]"
								data-paddingleft="[35,35,35,20]"
								style="z-index: 13; white-space: normal; font-size: 17px; line-height: 50px; font-weight: 600; color: rgba(255, 255, 255, 1.00); display: inline-block;font-family:'almarai', roboto;background-color:rgba(255, 255, 255, 0);border-color:rgba(255, 255, 255, 1.00);border-style:solid;border-width:1px 1px 1px 1px;border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">معلومات عنا
							</a>
						</li>
					</ul>
        ...
        <div class="content-block">
			...
			<div class="section-full bg-gray content-inner about-carousel-ser">
				<div class="container">
					<div class="section-head text-center">
						<h2 class="title">لماذا ادويت لوجيستيك<br/></h2>
						<p>هناك العديد من الاختلافات في مقاطع لوريم إيبسوم صناعة التنضيد كانت النص الوهمي القياسي لهذه الصناعة منذ أن كانت طابعة غير معروفة.</p>
					</div>
					<div class="about-ser-carousel owl-carousel owl-theme owl-btn-center-lr owl-dots-primary-full owl-btn-3 m-b30 wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
						<div class="item">
							<div class="dlab-box service-media-bx">
								...
								<div class="dlab-info text-center">
									<h2 class="dlab-title"><a href="about-1.html">مواقع التسوق التركية</a></h2>
									<p>دليل لجميع المواقع التركية من الماركات التركية والعالمية. يمكنك اختيار ما يناسبك والتواصل مع فريق عمل ادويت لوجيستيك لشرائها.</p>
									<a href="about-1.html" class="site-button btnhover13">زيارة الموقع</a>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="dlab-box service-media-bx">
								...
								<div class="dlab-info text-center">
									<h2 class="dlab-title"><a href="about-1.html"> التامين علي الشحنة</a></h2>
									<p> ادفع فقط 10٪ من قيمة الشحن وسوف تحصل على تعويض بقيمة المشتريات وقيمة الشحن في حال ضياع الشحنة او تلفها.شروط التأمين.</p>
									<a href="about-1.html" class="site-button btnhover13">اقرأ أكثر</a>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="dlab-box service-media-bx">
								...
								<div class="dlab-info text-center">
									<h2 class="dlab-title"><a href="about-1.html">فحص الجودة</a></h2>
									<p>ادفع فقط 10% من قيمة المشتريات وسوف يقوم  فريق العمل لدينا بفحصها بدقة وحرفية عالية للتأكد من تطابقها مع المواصفات المطلوبة</p>
									<a href="about-1.html" class="site-button btnhover13">اقرأ أكثر</a>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="dlab-box service-media-bx">
								...
								<div class="dlab-info text-center">
									<h2 class="dlab-title"><a href="about-1.html">تصوير الشحنة</a></h2>
									<p>يقوم فريق مختص بتصوير جميع مشترياتكم فور وصولها الى مقر شركة أدويت لوجيستيك.نفتخر باننا اول شركة تقدم هذه الخدمة التي تتيح لكم</p>
									<a href="about-1.html" class="site-button btnhover13">اقرأ أكثر</a>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="dlab-box service-media-bx">
								...
								<div class="dlab-info text-center">
									<h2 class="dlab-title"><a href="about-1.html">نظام التخزين</a></h2>
									<p>  نظام التخزين في مستودعات ادويت لوجيستيك عند وصول طلباتكم من المواقع التي تتسوقون منها الى مستودعات شركة ادويت لوجستيك سيتم احتساب</p>
									<a href="about-1.html" class="site-button btnhover13">اقرأ أكثر</a>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="dlab-box service-media-bx">
								...
								<div class="dlab-info text-center">
									<h2 class="dlab-title"><a href="about-1.html">تغليف الشحنات</a></h2>
									<p> تغليف الشحنات قبل شحنهانقوم بتغليف الشحنات وضغطها لتوفير الحجم والوزن، وبالتالي توفير اجور الشحن الى أقل قيمة ممكنة.عند وصول الطلبات الى</p>
									<a href="about-1.html" class="site-button btnhover13">اقرأ أكثر</a>
								</div>
							</div>
						</div>
			...
			<div class="section-full bg-img-fix content-inner-2 overlay-black-dark contact-action style2" style="background-image:url(images/background/bg2.jpg);">
				<div class="container">
					<div class="row relative">
						<div class="col-md-12 col-lg-8 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							<div class="contact-no-area">
								<h2 class="title">مركز تجميع الشحنات</h2>
                                 <h3 class="text-white">تسوق واشحن من تركيا</h3>
								 <ul>
									 <li class="text-white"><i class="ti-location-pin"></i>عنوان خاص بكم داخل تركيا لتجميع مشترياتكم.</li>
									 <li class="text-white"><i class="ti-briefcase"></i> خدمة اعادة التغليف للحصول على أقل وزن ممكن.</li>
									 <li class="text-white"><i class="ti-credit-card"></i> دفع آمن ببطاقات الائتمان.</li>
									 <li class="text-white"><i class="ti-camera"></i> تصوير مشترياتكم فور وصولها الى صندوقكم.</li>
									 <li class="text-white"><i class="ti-shield"></i> التأمين الشامل على الشحنة من الضياع والتلف.</li>
									 <li class="text-white"><i class="ti-truck"></i> تخزين المشتريات بشكل مجاني حتى 30 يوم.</li>								
								</ul>		
								<div class="contact-no">
									<div class="contact-left">
										<a href="https://www.youtube.com/watch?v=4kJnwew4EwM" class="popup-youtube video site-button appointment-btn btnhover13">مشاهدة فيديو تفصيلي</a>
										
									</div>
									<div class="contact-right">
										<a href="shop-and-ship.html" class="site-button appointment-btn btnhover13">الذهاب الى مركز التجميع</a>
										
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-12 col-lg-4 contact-img-bx relative wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
			...
			<div class="section-full bg-gray content-inner">
				<div class="container">
					<div class="section-head text-center">
						<h2 class="title"> خدمة اشتري لي</h2>
						<p>نقوم بالشراء لكم من جميع المواقع التركية</p>
					</div>
					<div class="section-content row">
						<div class="col-md-6 col-lg-4 col-sm-12 service-box style3 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
							<div class="icon-bx-wraper" data-name="01">
								...
								<div class="icon-content">
									<h2 class="dlab-tilte">التجميع</h2>
									<p>عنوان خاص لتجميع مشترياتكم في مستودعاتنا.</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-lg-4 col-sm-12 service-box style3 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
							<div class="icon-bx-wraper" data-name="02">
								...
								<div class="icon-content">
									<h2 class="dlab-tilte">رقم الهاتف</h2>
									<p>لست بحاجة الى رقم هاتف تركي. </p>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-lg-4 col-sm-12 service-box style3 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
							<div class="icon-bx-wraper" data-name="03">
								...
								<div class="icon-content">
									<h2 class="dlab-tilte">الدعم الفني</h2>
									<p>فريق دعم لمساعدتكم في جميع مراحل الشراء</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-lg-4 col-sm-12 service-box style3 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.8s">
							<div class="icon-bx-wraper" data-name="04">
								...
								<div class="icon-content">
									<h2 class="dlab-tilte">المصداقية</h2>
									<p>تصوير مشترياتكم فور وصولها الى صندوقكم.</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-lg-4 col-sm-12 service-box style3 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
							<div class="icon-bx-wraper" data-name="05">
								...
								<div class="icon-content">
									<h2 class="dlab-tilte"> اعادة التغليف</h2>
									<p>خدمة اعادة التغليف للحصول على أقل وزن ممكن</p>
								</div>
							</div>
						</div>
						<div class="col-md-6 col-lg-4 col-sm-12 service-box style3 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
							<div class="icon-bx-wraper" data-name="06">
								...
								<div class="icon-content">
									<h2 class="dlab-tilte"> المتابعة</h2>
									<p>متابعة حالة الطلب لجميع المشتريات </p>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="section-full text-white bg-img-fix content-inner overlay-black-dark counter-staus-box" style="background-image:url(images/background/bg4.jpg);">
				<div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-12 col-sm-12 wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							<div class="section-head text-white">
								<a href="https://www.youtube.com/watch?v=7dUK0vB0v2U" class="popup-youtube video play-btn"><span><i class="fas fa-play"></i></span>مشاهدة فيديو</a>
								<h2 class="title">تقدم أدويت لوجيستيك خدمات نقل البضائع من تركيا الى كافة أنحاء العالم</h2>
							</div>
						</div>
            ...
            <div class="container">
                <div class="ft-contact wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
					<div class="ft-contact-bx">
						...
						<p>GÜRSEL MAH. NİŞANE CAD. IŞIL SOK. NO:2
							KAĞITHANE/İSTANBUL
							TÜRKİYE</p>
					</div>
					<div class="ft-contact-bx">
						...
						<p>+90 536 849 72 72</p>
					</div>
					<div class="ft-contact-bx">
						<img src="images/icon/icon3.png" alt=""/>
						<h4 class="title">الاتصال عبر البريد الالكتروني</h4>
						<p>8901 Marmora Road مدينة تشي منه ، فيتنام</p>
					</div>
				</div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="widget widget_about">
							<h4 class="footer-title">عن ادويت لوجيستيك</h4>
                            <p>الجيل الجديد من خدمات الشحن عبر الانترنت</p>
							<a href="about-1.html" class="readmore">اقرأ أكثر</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="widget">
                            ...
                            <ul class="list-2">                              
                                ...
                                <li><a href="terms.html">الشروط والالتزامات</a></li>
								<li><a href="about-1.html">من نحن</a></li>
                ...
                <div class="footer-bottom-in">
					...
					<div class="footer-bottom-social">
						<ul class="dlab-social-icon dez-border">
							<li><a class="fab fa-youtube" target="_blank" href="https://www.youtube.com/channel/UCwiLtHl7rdUurCMYFwFr3SA"></a></li>
							<li><a class="fab fa-facebook-f" target="_blank" href="https://www.facebook.com/Adwhit.Lojistik.TR/"></a></li>
							<li><a class="fab fa-twitter" target="_blank" href="https://twitter.com/adwhitlojistik"></a></li>
							<li><a class="fab fa-whatsapp" target="_blank" href="https://api.whatsapp.com/send?phone=902122967662"></a></li>
						</ul>
					</div>
                </div>
            </div>
